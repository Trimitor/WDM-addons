...
function Astrolabe:GetCurrentVirtualMapContinent()
    local C, Z = self:GetCurrentVirtualMapCZ()
    return C
end
function Astrolabe:GetCurrentVirtualMapZone()
    local C, Z = self:GetCurrentVirtualMapCZ()
    return Z
end
...
function Astrolabe:TranslateWorldMapPosition(C, Z, xPos, yPos, nC, nZ)
    ...
    elseif (C and nC) and (WorldMapSize[C].parentContinent == WorldMapSize[nC].parentContinent) then
        ...
        if not xPos or not yPos then
            return
        end -- there is no such zone. why are you asking me such silly things? you are a terrible person. leave me in my despair.
